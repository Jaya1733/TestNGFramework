...
public class SamplePageClass extends BasePage {
	...
	public void chooseFileButton() throws InterruptedException, IOException {
		System.out.println(System.getProperty("user.dir")+util.getPropertyValue("profilePic"));
		chooseFileBtn.sendKeys(System.getProperty("user.dir")+util.getPropertyValue("profilePic"));
	...
	/*
	 * Verify Text message in next page
	 */
	public void verifyTextMessage() throws InterruptedException, IOException {
		Assert.assertEquals(messageSentText.getText(), "Message Sent ");
		util.captureAndEmbedScreenshot("Message Sent verified Text");
	}
}
